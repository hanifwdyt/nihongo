    ...
    <div className="flex flex-col items-center justify-center flex-1 py-20">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <div className="font-jp text-4xl text-emerald-600 mb-3">はじめまして</div>
          <h1 className="text-3xl font-black text-zinc-900 dark:text-zinc-100">
            Create <span className="font-display italic">account</span>
          </h1>
          <p className="mt-2 text-zinc-500 text-sm">Start your Japanese learning journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-zinc-500 dark:text-zinc-400 pl-1">Your name</label>
            <input
              type="text"
              value={name}
